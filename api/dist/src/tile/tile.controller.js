...
var TileController = /** @class */ (function () {
    ...
    TileController.prototype.createTiles = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.tileService.createTiles(req.body)];
            });
        });
    };
    TileController.prototype.getTileById = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.tileService.tile({ id: Number(req.params.id) })];
            });
        });
    };
